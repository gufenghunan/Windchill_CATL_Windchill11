...
package com.ptc.windchill.enterprise.attachments.forms;
...
public class SecondaryAttachmentsSubFormProcessor extends AbstractAttachmentsSubFormProcessor {
	...
	public FormResult preProcess(NmCommandBean arg0, List<ObjectBean> arg1) throws WTException {
		...
		String issoft = arg0.getTextParameter("catlsoft");
		//System.out.println("issofttttttttttttttttttttttt\t"+issoft);
		if(issoft !=null & "soft".equals(issoft)){
			arg2.setStatus(FormProcessingStatus.SUCCESS);
			return arg2;
		}
		...
		for (Iterator arg4 = arg1.iterator(); arg4.hasNext(); this.getObjectBeanInfo(arg5).put("locale",
			...
			List arg11 = arg5.getAddedItemsByName("wp.attachments.list.editable");
			...
			arg13 = arg5.getAddedItemsByName("attachments.list.editable");
			...
			if (arg10 != null && arg10.size() > 0) {
				arg3 = this.getNewAttachments(arg10, arg6, arg5, ContentRoleType.SECONDARY);
			...
			if (arg9) {
				...
				arg20 = arg5.getRemovedItemsByName("attachments.list.editable");
				arg21 = arg5.getAddedItemsByName("wp.attachments.list.editable");
				arg20.addAll(arg21);
				...
				arg18 = arg5.getRemovedItemsByName("attachments.list.editable");
				arg20 = arg5.getRemovedItemsByName("wp.attachments.list.editable");
				arg18.addAll(arg20);
			...
			for (int arg7 = 0; arg7 < arg0.size(); ++arg7) {
				...
				try {
					...
					if (!this.isMandatoryDataAvailable(arg12)) {
						throw new ContentException("wt.content.contentResource", "73", (Object[]) null);
					}
	...
	private List<ContentItem> populatePropagatedAttachments(ObjectBean arg0) throws WTException {
		...
		List arg1 = this.getNewAttachments(arg5, arg4, arg0, ContentRoleType.SECONDARY);
	...
	static {
		try {
			log = LogR.getLogger(SecondaryAttachmentsSubFormProcessor.class.getName());
