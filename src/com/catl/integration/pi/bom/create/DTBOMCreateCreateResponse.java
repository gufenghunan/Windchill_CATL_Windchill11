...
/**
 * <p>Java class for DT_BOM_CreateCreateResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DT_BOM_CreateCreateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "DT_BOM_CreateCreateResponse", propOrder = {
    "eacknow",
    "tbomout"
})
public class DTBOMCreateCreateResponse {

    @XmlElement(name = "E_ACKNOW", required = true)
    protected DTACKNOW2 eacknow;
    @XmlElement(name = "T_BOM_OUT")
    protected List<DTBOMCreateCreateResponse.TBOMOUT> tbomout;
     ...
     * {@link DTBOMCreateCreateResponse.TBOMOUT }
     * 
     * 
     */
    public List<DTBOMCreateCreateResponse.TBOMOUT> getTBOMOUT() {
        if (tbomout == null) {
            tbomout = new ArrayList<DTBOMCreateCreateResponse.TBOMOUT>();
        }
        return this.tbomout;
    }
