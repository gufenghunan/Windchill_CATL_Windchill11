...
/**
 * <p>DT_ZEIVRCreateResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_ZEIVRCreateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "DT_ZEIVRCreateResponse", propOrder = {
    "eacknow",
    "treturn"
})
public class DTZEIVRCreateResponse {

    @XmlElement(name = "E_ACKNOW", required = true)
    protected EACKNOW eacknow;
    @XmlElement(name = "T_RETURN")
    protected List<DTZEIVRCreateResponse.TRETURN> treturn;
     ...
     * {@link DTZEIVRCreateResponse.TRETURN }
     * 
     * 
     */
    public List<DTZEIVRCreateResponse.TRETURN> getTRETURN() {
        if (treturn == null) {
            treturn = new ArrayList<DTZEIVRCreateResponse.TRETURN>();
        }
        return this.treturn;
    }
