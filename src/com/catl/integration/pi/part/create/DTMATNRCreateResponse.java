...
/**
 * <p>Java class for DT_MATNRCreateResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DT_MATNRCreateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "DT_MATNRCreateResponse", propOrder = {
    "eacknow",
    "treturn"
})
public class DTMATNRCreateResponse {

    @XmlElement(name = "E_ACKNOW", required = true)
    protected DTACKNOW2 eacknow;
    @XmlElement(name = "T_RETURN")
    protected List<DTMATNRCreateResponse.TRETURN> treturn;
     ...
     * {@link DTMATNRCreateResponse.TRETURN }
     * 
     * 
     */
    public List<DTMATNRCreateResponse.TRETURN> getTRETURN() {
        if (treturn == null) {
            treturn = new ArrayList<DTMATNRCreateResponse.TRETURN>();
        }
        return this.treturn;
    }
