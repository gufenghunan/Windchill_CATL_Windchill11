...
/**
 * <p>DT_ZPLMNCreateResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_ZPLMNCreateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "DT_ZPLMNCreateResponse", propOrder = {
    "eacknow",
    "treturn"
})
public class DTZPLMNCreateResponse {

    @XmlElement(name = "E_ACKNOW", required = true)
    protected EACKNOW eacknow;
    @XmlElement(name = "T_RETURN")
    protected List<DTZPLMNCreateResponse.TRETURN> treturn;
     ...
     * {@link DTZPLMNCreateResponse.TRETURN }
     * 
     * 
     */
    public List<DTZPLMNCreateResponse.TRETURN> getTRETURN() {
        if (treturn == null) {
            treturn = new ArrayList<DTZPLMNCreateResponse.TRETURN>();
        }
        return this.treturn;
    }
