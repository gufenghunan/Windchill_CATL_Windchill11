...
/**
 * <p>DT_FAECreateResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_FAECreateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "DT_FAECreateResponse", propOrder = {
    "eacknow",
    "treturn"
})
public class DTFAECreateResponse {

    @XmlElement(name = "E_ACKNOW", required = true)
    protected EACKNOW eacknow;
    @XmlElement(name = "T_RETURN")
    protected List<DTFAECreateResponse.TRETURN> treturn;
     ...
     * {@link DTFAECreateResponse.TRETURN }
     * 
     * 
     */
    public List<DTFAECreateResponse.TRETURN> getTRETURN() {
        if (treturn == null) {
            treturn = new ArrayList<DTFAECreateResponse.TRETURN>();
        }
        return this.treturn;
    }
