...
/**
 * <p>DT_MSTAECreateResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_MSTAECreateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "DT_MSTAECreateResponse", propOrder = {
    "eacknow",
    "treturn"
})
public class DTMSTAECreateResponse {

    @XmlElement(name = "E_ACKNOW", required = true)
    protected EACKNOW eacknow;
    @XmlElement(name = "T_RETURN")
    protected List<DTMSTAECreateResponse.TRETURN> treturn;
     ...
     * {@link DTMSTAECreateResponse.TRETURN }
     * 
     * 
     */
    public List<DTMSTAECreateResponse.TRETURN> getTRETURN() {
        if (treturn == null) {
            treturn = new ArrayList<DTMSTAECreateResponse.TRETURN>();
        }
        return this.treturn;
    }
