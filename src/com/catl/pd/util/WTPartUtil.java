...
public class WTPartUtil implements RemoteAccess{
	  ...
	  public static List queryPDAsmParts()throws QueryException, WTPropertyVetoException, WTException
	  {
		QueryResult qr=getPartsByPrefix(ConstantPD.config_pdasm_clf.toUpperCase());
