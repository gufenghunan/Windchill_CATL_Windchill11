...
public class PlatformConsole2 implements RemoteAccess {
	public static void step(int step, Scanner sc, RemoteMethodServer rms) throws Exception {
		...
		case 1:
			...
			if(sure.toUpperCase().equals("Y")){
				...
				String msg=(String) rms.invoke("washPlatformByLib", PlatformConsole2.class.getName(), null, new Class[]{String.class,String.class},new Object[]{param1,sign});
		...
		case 2:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("washPlatformByPro", PlatformConsole2.class.getName(), null, new Class[]{String.class,String.class},new Object[]{param1,sign});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
		...
		case 3:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("washPlatformByPrefix", PlatformConsole2.class.getName(), null, new Class[]{String.class,String.class},new Object[]{param1,sign});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
		...
		case 4:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("washPlatformWithChildsByPrefix", PlatformConsole2.class.getName(), null, new Class[]{String.class,String.class},new Object[]{param1,sign});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
		...
		case 5:
			...
			if(cmd.equals("1")){
				...
				System.out.println("请确认,刷路径"+param1+"文件中的BOM,产品线标识为"+sign+"(Y,N)");
			}
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				if(cmd.equals("1")){
				String msg=(String) rms.invoke("washPlatformByExcel", PlatformConsole2.class.getName(), null, new Class[]{String.class,String.class},new Object[]{param1,sign});
				System.out.println(msg);
				System.out.println();
				}else{
				String msg=(String) rms.invoke("washBomPlatformByExcel", PlatformConsole2.class.getName(), null, new Class[]{String.class,String.class},new Object[]{param1,sign});
				System.out.println(msg);
				System.out.println();
				}
			}
		...
		case 6:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("clearPlatformByLib", PlatformConsole2.class.getName(), null, new Class[]{String.class},new Object[]{param1});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
		...
		case 7:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("clearPlatformByPro", PlatformConsole2.class.getName(), null, new Class[]{String.class},new Object[]{param1});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
		...
		case 8:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("clearPlatformByPrefix", PlatformConsole2.class.getName(), null, new Class[]{String.class},new Object[]{param1});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
    	...
    	case 9:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("clearPlatformByExcel", PlatformConsole2.class.getName(), null, new Class[]{String.class},new Object[]{param1});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
    	...
    	case 10:
			...
			if(sure.toUpperCase().equals("Y")){
				System.out.println("正在执行...");
				String msg=(String) rms.invoke("clearAllPartPlatform", PlatformConsole2.class.getName(), null, new Class[]{},new Object[]{});
				System.out.println(msg);
				System.out.println();
			}
			showControlPanel(sc, rms);
	...
	public static String washPlatformByPrefix(String numberprefix, String value)
		...
		while (qr.hasMoreElements()) {
			...
			System.out.println(count.append("受影响部件").append(qr.size()).append("已成功执行").append(count));
		}
	...
	public static String washPlatformByExcel(String path,String value)
		...
		int success=0;
			for (int i = 0; i < result.length; i++) {
				...
				success=success+setPlatform(part, value);
				StringBuffer count=new StringBuffer();
				System.out.println(count.append("受影响部件").append(result.length).append("已成功执行").append(count));
			}
	...
	public static String washBomPlatformByExcel(String path,String value)
		...
		int success=0;
			for (int i = 0; i < result.length; i++) {
				...
				success=success+setPlatform(part, value);
				StringBuffer count=new StringBuffer();
				System.out.println(count.append("受影响BOM头").append(result.length).append("已成功执行").append(count));
	...
	public static String washPlatformByLib(String containername, String value)
		...
		for (int i = 0; i < parts.size(); i++) {
			...
			success=success+setPlatform(part, value);
			StringBuffer count=new StringBuffer();
			System.out.println(count.append("受影响部件").append(parts.size()).append("已成功执行").append(count));
		}
	...
	public static String washPlatformWithChildsByPrefix(String numberprefix,
		...
		while (qr.hasMoreElements()) {
			...
			for (int i = 0; i < childs.size(); i++) {
				...
				StringBuffer count=new StringBuffer();
				System.out.println(count.append("受影响BOM头").append(qr.size()).append("已成功执行").append(count));
			}
		}
	...
	public static void washPlatformWithChildsByPart(WTPart part,String value) throws WTException, WTPropertyVetoException,
		...
		List childs=new ArrayList();
		StringBuffer buffer=new StringBuffer();
		System.out.print(buffer.append(part.getNumber()).append("获取").append(part.getNumber()).append("子件"));
		CommonUtil.getAllChildParts(childs, part, part.getViewName());
		System.out.println(childs.size());
		for (int i = 0; i < childs.size(); i++) {
			WTPart child=(WTPart) childs.get(i);
    ...
    public static void clearPartPlatform(WTPart part) throws WTException, WTPropertyVetoException, RemoteException{
    	WTPartMaster partmaster = part.getMaster();
		 ...
		 if(!StringUtils.isEmpty(platform)){
			 System.out.println("删除产品线标识="+part.getNumber());
			 IBAUtility iba = new IBAUtility(partmaster);
