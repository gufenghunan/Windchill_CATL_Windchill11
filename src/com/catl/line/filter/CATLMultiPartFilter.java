...
public class CATLMultiPartFilter extends DefaultSimpleValidationFilter{
	...
	public UIValidationStatus preValidateAction(UIValidationKey key,
		...
		UIValidationStatus status = UIValidationStatus.HIDDEN;
			...
			if(persistable instanceof Folder){
				...
				if(folder.getName().equals(PropertiesUtil.getValueByKey("config_part_folder"))){//在线束Autocadcad文件夹
					WTPrincipal user;
					try {
