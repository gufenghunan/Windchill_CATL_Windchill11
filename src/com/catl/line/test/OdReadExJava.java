...
import com.opendesign.td.EdgeArray;
import com.opendesign.td.ExHostAppServices;
import com.opendesign.td.OdCmColor;
import com.opendesign.td.OdCmColorArray;
import com.opendesign.td.OdDbAbstractViewTableRecord;
...
import com.opendesign.td.OdDbDictionary;
import com.opendesign.td.OdDbDictionaryIterator;
import com.opendesign.td.OdDbDimAssoc;
import com.opendesign.td.OdDbDimStyleTable;
import com.opendesign.td.OdDbDimStyleTableRecord;
...
import com.opendesign.td.OdDbLayerTable;
import com.opendesign.td.OdDbLayerTableRecord;
import com.opendesign.td.OdDbLayout;
import com.opendesign.td.OdDbLine;
import com.opendesign.td.OdDbLinetypeTable;
import com.opendesign.td.OdDbLinetypeTableRecord;
...
import com.opendesign.td.OdDbMTextFragment;
import com.opendesign.td.OdDbMTextFragmentCallback;
import com.opendesign.td.OdDbMTextIndents;
import com.opendesign.td.OdDbMlineStyle;
import com.opendesign.td.OdDbObject;
import com.opendesign.td.OdDbObjectId;
import com.opendesign.td.OdDbObjectIdArray;
import com.opendesign.td.OdDbObjectIterator;
import com.opendesign.td.OdDbOsnapPointRef;
import com.opendesign.td.OdDbPolyline;
import com.opendesign.td.OdDbProxyExt;
import com.opendesign.td.OdDbProxyObject;
import com.opendesign.td.OdDbRegAppTable;
import com.opendesign.td.OdDbRegAppTableRecord;
import com.opendesign.td.OdDbSpline;
import com.opendesign.td.OdDbSymbolTable;
import com.opendesign.td.OdDbSymbolTableIterator;
import com.opendesign.td.OdDbSymbolTableRecord;
import com.opendesign.td.OdDbText;
import com.opendesign.td.OdDbTextStyleTable;
import com.opendesign.td.OdDbTextStyleTableRecord;
import com.opendesign.td.OdDbUCSTable;
import com.opendesign.td.OdDbUCSTableRecord;
import com.opendesign.td.OdDbViewTable;
import com.opendesign.td.OdDbViewTableRecord;
import com.opendesign.td.OdDbViewportTable;
import com.opendesign.td.OdDbViewportTableRecord;
import com.opendesign.td.OdDbXrecord;
import com.opendesign.td.OdDbXrefFullSubentPath;
import com.opendesign.td.OdDxfCode;
import com.opendesign.td.OdDxfCode.Type;
import com.opendesign.td.OdResBuf;
import com.opendesign.td.SaveType;
import com.opendesign.td.TD_Db;
import com.opendesign.td.TextHorzMode;
import com.opendesign.td.TextVertMode;
import com.opendesign.td.Visibility;
import com.opendesign.td.XrefStatus;
...
public class OdReadExJava {
  ...
  public static void main(String[] args) 
  {
			...
			String srcFileName = "D://ģ��.dwg";
            String dstFileName = "D://aa.dwg";
...
//			} else 
//				if (obj.isKindOf(OdDbHatch.desc()))  { // obj instanceof OdDbHatch
...
//			} 
		...
		//else
			if (obj.isKindOf(OdDbBlockReference.desc()))  { // obj instanceof OdDbBlockReference
...
//			}
	...
	void dumpAttributeData(int indent, OdDbAttribute attr, int i)
	{
	  ...
	  writeLine(indent, "ConstantLine",               _toString(attr.isConstant()));
	...
	//	    writeLine(indent++, "Edges");
	    for (int i = 0; i < (int) edges.size(); i++)
	    {
	      ...
	      switch (edge.type ()) 
	      {
	        case kLineSeg2d   :                                            break;
	        case kCircArc2d   : dumpCircularArcEdge(indent + 1, edge);   break;
	        case kEllipArc2d  : dumpEllipticalArcEdge(indent + 1, edge); break;
	        case kNurbCurve2d : dumpNurbCurveEdge(indent + 1, edge);     break;
	        default:break;
	      }
	...
	void dumpSimplePolylineAttributes(OdDbPolyline poly, int indent) 
	{
		...
		if (!poly.hasWidth())
		{
			writeLine(indent, "ConstantLine Width",         _toString(poly.getConstantWidth()));
		}
	...
	private String toStringLW(int val) {
	  ...
	  switch (val)
	  {
		case LineWeight.kLnWt000          : retVal = ("kLnWt000");         break;
		case LineWeight.kLnWt005          : retVal = ("kLnWt005");         break;
		case LineWeight.kLnWt009          : retVal = ("kLnWt009");         break;
		case LineWeight.kLnWt013          : retVal = ("kLnWt013");         break;
		case LineWeight.kLnWt015          : retVal = ("kLnWt015");         break;
		case LineWeight.kLnWt018          : retVal = ("kLnWt018");         break;
		case LineWeight.kLnWt020          : retVal = ("kLnWt020");         break;
		case LineWeight.kLnWt025          : retVal = ("kLnWt025");         break;
		case LineWeight.kLnWt030          : retVal = ("kLnWt030");         break;
		case LineWeight.kLnWt035          : retVal = ("kLnWt035");         break;
		case LineWeight.kLnWt040          : retVal = ("kLnWt040");         break;
		case LineWeight.kLnWt050          : retVal = ("kLnWt050");         break;
		case LineWeight.kLnWt053          : retVal = ("kLnWt053");         break;
		case LineWeight.kLnWt060          : retVal = ("kLnWt060");         break;
		case LineWeight.kLnWt070          : retVal = ("kLnWt070");         break;
		case LineWeight.kLnWt080          : retVal = ("kLnWt080");         break;
		case LineWeight.kLnWt090          : retVal = ("kLnWt090");         break;
		case LineWeight.kLnWt100          : retVal = ("kLnWt100");         break;
		case LineWeight.kLnWt106          : retVal = ("kLnWt106");         break;
		case LineWeight.kLnWt120          : retVal = ("kLnWt120");         break;
		case LineWeight.kLnWt140          : retVal = ("kLnWt140");         break;
		case LineWeight.kLnWt158          : retVal = ("kLnWt158");         break;
		case LineWeight.kLnWt200          : retVal = ("kLnWt200");         break;
		case LineWeight.kLnWt211          : retVal = ("kLnWt211");         break;
		case LineWeight.kLnWtByLayer      : retVal = ("kLnWtByLayer");     break;
		case LineWeight.kLnWtByBlock      : retVal = ("kLnWtByBlock");     break;
		case LineWeight.kLnWtByLwDefault  : retVal = ("kLnWtByLwDefault"); break;
	  }
	  return retVal; 
	}
	...
	public String toString(Visibility val)
	{
		...
		switch (val) 
		{
			case kVisible   : retVal = "kVisible";   break;
			case kInvisible : retVal = "kInvisible"; break;
		}
	    return retVal; 
	}
	...
	public String toString(OdDbPolyline.SegType val)
	{
	  ...
	  switch (val) 
	  {
		case kArc        : retVal = "kArc";        break;
		case kCoincident : retVal = "kCoincident"; break;
		case kEmpty      : retVal = "kEmpty";      break;  
		case kLine       : retVal = "kLine";       break;  
		case kPoint      : retVal = "kPoint";      break;  
	  }
	  return retVal;
	}
	...
	public String toString(TextHorzMode val)
	{
	  ...
	  switch (val) 
	  {
		case kTextLeft        : retVal = "kTextLeft";   break;
		case kTextCenter      : retVal = "kTextCenter"; break;
		case kTextRight       : retVal = "kTextRight";  break;
		case kTextAlign       : retVal = "kTextAlign";  break;
		case kTextMid         : retVal = "kTextMid";    break;
		case kTextFit         : retVal = "kTextFit";    break;
	  }
	  return retVal;
	}
	...
	public String toString(TextVertMode val)
	{
	  ...
	  switch (val) 
	  {
		case kTextBase        : retVal = "kTextBase"; break;
		case kTextBottom      : retVal = "kTextBottom"; break;
		case kTextVertMid     : retVal = "kTextVertMid"; break;
		case kTextTop         : retVal = "kTextTop"; break;
	  }
	  return retVal;
	}
	...
	String toString(HatchPatternType val)
	{
	  ...
	  switch (val) 
	  {
	    case kPreDefined    : retVal = "kPreDefined";    break;
	    case kUserDefined   : retVal = "kUserDefined";   break;
	    case kCustomDefined : retVal = "kCustomDefined"; break;
	  }
	  return retVal;
	}
	...
	String toString(HatchObjectType val)
	{
	  ...
	  switch (val) 
	  {
	    case kHatchObject    : retVal = "kHatchObject";    break;
	    case kGradientObject : retVal = "kGradientObject"; break;
	  }
	  return retVal;
	}
	...
	String toString(HatchStyle val)
	{
	  ...
	  switch (val) 
	  {
	    case kNormal : retVal = "kNormal";    break;
	    case kOuter  : retVal = "kOuter";     break;
	    case kIgnore : retVal = "kIgnore";    break;
	  }
	  return retVal;
	}
	...
	String toString(AttachmentPoint val)
	{
	  ...
	  switch (val) 
	  {
	    case kTopLeft      : retVal = "kTopLeft";      break;
	    case kTopCenter    : retVal = "kTopCenter";    break;
	    case kTopRight     : retVal = "kTopRight";     break;
	    case kMiddleLeft   : retVal = "kMiddleLeft";   break;
	    case kMiddleCenter : retVal = "kMiddleCenter"; break;
	    case kMiddleRight  : retVal = "kMiddleRight";  break;
	    case kBottomLeft   : retVal = "kBottomLeft";   break;
	    case kBottomCenter : retVal = "kBottomCenter"; break;
	    case kBottomRight  : retVal = "kBottomRight";  break;
	    case kBaseLeft     : retVal = "kBaseLeft";     break;
	    case kBaseCenter   : retVal = "kBaseCenter";   break;
	    case kBaseRight    : retVal = "kBaseRight";    break;
	    case kBaseAlign    : retVal = "kBaseAlign";    break;
	    case kBottomAlign  : retVal = "kBottomAlign";  break;
	    case kMiddleAlign  : retVal = "kMiddleAlign";  break;
	    case kTopAlign     : retVal = "kTopAlign";     break;
	    case kBaseFit      : retVal = "kBaseFit";      break;
	    case kBottomFit    : retVal = "kBottomFit";    break;
	    case kMiddleFit    : retVal = "kMiddleFit";    break;
	    case kTopFit       : retVal = "kTopFit";       break;
	    case kBaseMid      : retVal = "kBaseMid";      break;
	    case kBottomMid    : retVal = "kBottomMid";    break;
	    case kMiddleMid    : retVal = "kMiddleMid";    break;
	    case kTopMid       : retVal = "kTopMid";       break;
	  }
	  return retVal;
	}
	...
	String toString(FlowDirection val)
	{
	  ...
	  switch (val) 
	  {
	    case kLtoR     : retVal = "kLtoR";     break;
	    case kRtoL     : retVal = "kRtoL";     break;
	    case kTtoB     : retVal = "kTtoB";     break;
	    case kBtoT     : retVal = "kBtoT";     break;
	    case kByStyle  : retVal = "kByStyle";  break;
	  }
	  return retVal;
	}
