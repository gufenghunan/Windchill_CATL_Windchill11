...
public interface RIService {
	 ...
	 * @throws Exception
	 */
	void exportSheet(String wtDocOid,String name,String level,String remark,String sheetname, HttpServletRequest request,HttpServletResponse response) throws Exception;
	...
	boolean isSpeicalGroupUser(String containerOid) throws WTException;
