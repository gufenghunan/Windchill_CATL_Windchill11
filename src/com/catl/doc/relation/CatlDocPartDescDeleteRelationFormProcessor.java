...
import com.ptc.windchill.enterprise.part.forms.DocPartDescDeleteRelationFormProcessor;

public class CatlDocPartDescDeleteRelationFormProcessor extends DocPartDescDeleteRelationFormProcessor{
	@Override
	public FormResult doOperation(NmCommandBean paramNmCommandBean, List<ObjectBean> paramList) throws WTException {
		...
		if (objOrig instanceof WTDocument) {
			...
			DocPartRelationUtil.deleteDesc(doc, list);
		}
