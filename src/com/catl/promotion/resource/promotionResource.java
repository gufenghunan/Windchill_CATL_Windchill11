...
public final class promotionResource extends WTListResourceBundle {
    ...
    @RBEntry("Please select objects!")
    public static final String NO_CHOICE = "noChoice.description";
    
    @RBEntry("No Releated Workflow!")
    ...
    @RBEntry("无有效上层BOM的物料报表流程启动失败，请联系管理员排除问题后再启动!")
    ...
    @RBEntry("new FAE materials maturity request") 
    ...
    @RBEntry("FAE Materials Maturity Up")
    ...
    @RBEntry("产品线标识更改单")
    public static final String PROMOTION_CONSTANT_19 = "PlatformChangePNTitle";
