...
public class PCPromotionNameAttributePopulator extends PromotionNameAttributePopulator {

	private static final Logger LOGGER = Logger.getLogger(PCPromotionNameAttributePopulator.class);
