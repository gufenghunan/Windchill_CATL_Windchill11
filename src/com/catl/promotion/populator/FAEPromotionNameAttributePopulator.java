...
public class FAEPromotionNameAttributePopulator extends PromotionNameAttributePopulator {

	private static final Logger LOGGER = Logger.getLogger(FAEPromotionNameAttributePopulator.class);
