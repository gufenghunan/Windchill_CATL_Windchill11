...
public class PNPromotionNameAttributePopulator extends PromotionNameAttributePopulator {

	private static final Logger LOGGER = Logger.getLogger(PNPromotionNameAttributePopulator.class);
