...
@ComponentBuilder(value = { "com.catl.promotion.mvc.builders.SourceChangeTableBuilder" })
public class SourceChangeTableBuilder extends AbstractXmlObjectTableBuilder{
