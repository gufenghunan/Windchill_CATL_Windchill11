...
public class SourceChangeCommandsAdd implements WindchillActionCommand {
	...
	public FormResult executeCommand(NmCommandBean nmcommandbean) throws WTException {
		...
		try {
			...
			SourceChangeXmlObjectUtil.addSourceChangeObjects(pbo, soids);
			PlatformChangeXmlObjectUtil.addPlatformChangeObjects(pbo, soids);
		} catch (Exception e) {
			e.printStackTrace();
