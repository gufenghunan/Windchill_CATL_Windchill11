...
public class PlatformChangeProcessorDelegate extends WorkflowTaskFormProcessorDelegate {

	private static Logger logger = Logger.getLogger(PlatformChangeProcessorDelegate.class);
	...
	public void copyAttributes(NmCommandBean clientData, List<ObjectBean> objectBeans, XmlObject xmlObjectFromWeb, XmlObject xmlObjectInDatabase)
		...
		if (description.indexOf(PromotionConst.platform_change_submit) > 0) {
			attributeNames = new String[] { "platformAfter", "cause"};
		}

		if (xmlObjectInDatabase instanceof PlatformChangeXmlObjectBean) {
