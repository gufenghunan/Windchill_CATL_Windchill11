...
public class IESoapServletLocator extends org.apache.axis.client.Service implements com.catl.ecad.wsdlclient.IESoapServlet {
    ...
    private java.lang.String IESoapPort_address = "http://catl-plm.catlbattery.com/Windchill/servlet/RPC";
    ...
    public com.catl.ecad.wsdlclient.IEService getIESoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.catl.ecad.wsdlclient.SoapBindingStub _stub = new com.catl.ecad.wsdlclient.SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.catl.ecad.wsdlclient.IEService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.catl.ecad.wsdlclient.SoapBindingStub _stub = new com.catl.ecad.wsdlclient.SoapBindingStub(new java.net.URL(IESoapPort_address), this);
                _stub.setPortName(getIESoapPortWSDDServiceName());
                return _stub;
            }
        }
