...
public class SyncTool {
	...
	public static void getComment(String config_sheetname,String dataFilePath) throws Exception{
		FileInputStream dataStream=new FileInputStream(dataFilePath);
		XSSFWorkbook datawb=new XSSFWorkbook(dataStream);
		XSSFSheet dataSheet=datawb.getSheet(config_sheetname);
		XSSFRow dataRow=null;
		XSSFCell dataCell=null;
		for(int rowIndex=0;rowIndex<300;rowIndex++){
			...
			for(int cellIndex=0;cellIndex<100;cellIndex++){
				...
				if(dataCell.getCellComment()!=null){
					...
					CommonHelper.getCellValue(dataCell, cellAttr);
					System.out.println(region+"------"+cellAttr.getValue());
					System.out.println("class=\"symbol\" ext:qtip="+"\""+dataCell.getCellComment().getString().getString().replace("\n", "<br/>")+"\"");
			   }
	...
	public static void main1(String[] args) throws Exception {
		...
		//比较公式的区别,false
		compareFormulaAndSet(config_sheetname,"E://tmp//data.xlsx", "E://tmp//battery_math.xlsx",false);
        compareStringCellAndSet(config_sheetname,"E://tmp//data.xlsx", "E://tmp//battery_math.xlsx",true);
		updateVersion("E://tmp//new//data.xlsx","E://tmp//new//battery_math.xlsx");
		forceSetFormulaCell("E://tmp//data.xlsx", "E://tmp//battery_math.xlsx", "BOM", "C42");
		forceSetNumberCell("E://tmp//data.xlsx", "E://tmp//battery_math.xlsx", "BOM", "F42");
	}
	
	public static void main(String[] args) throws Exception {
		getComment("05.设计输出","E://tmp//bak//work//111.xlsx");
	}
