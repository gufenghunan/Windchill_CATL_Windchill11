...
public class WTPartUtil implements RemoteAccess{
	  ...
	  public static List queryBatteryAsmParts()throws QueryException, WTPropertyVetoException, WTException
	  {
		QueryResult qr=getPartsByPrefix(ConstantBattery.config_batteryasm_clf.toUpperCase());
		List list=new ArrayList();
	    while (qr.hasMoreElements()) {
	      WTPart part = (WTPart)qr.nextElement();
	      if(part.getFolderPath().contains(ConstantBattery.config_libary_asmfolder)){
	    	  Map map=new HashMap();
