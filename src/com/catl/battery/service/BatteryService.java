package com.catl.battery.service;
...
public interface BatteryService {
	 ...
	 * 生成的excel需要清除计算公式
	 * 创建文档主内容所在临时目录为ConstantBattery.base_battery_path/当前用户名/文档名称.xls
	...
	/**
	 * 判断目录ConstantBattery.base_battery_path/当前用户是否存在
	 * 如果存在且包含xls文件则返回字符串"已存在"
	 * 如果不存在则创建目录ConstantBattery.base_battery_path/当前用户
	 * 拷贝ConstantBattery.config_batterymath_xls到目录ConstantBattery.base_battery_path/当前用户
	...
	/**
	 * 将页面所填的信息jsonstr处理
	 * 按照配置表ConstantBattery.config_batteryupdate_xls
	 ...
	 * @throws Exception
	 */
	JSONArray updateBattery(String wtDocOid) throws Exception;
	 ...
	 * @throws Exception
	 */
	void exportIfConf(String wtDocOid,String name,String level,String remark,HttpServletRequest request,HttpServletResponse response) throws Exception;
	 ...
	 * @throws Exception
	 */
	void importIfConf(MultipartFile file,String wtDocOid, String name, String level,String remark) throws Exception;
	...
	void syncTemp(String filename) throws WTException, Exception; 
}
