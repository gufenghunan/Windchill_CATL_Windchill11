...
public class ConstantBattery {
	public static String evc_group_admin="EVC配置管理员组";
	//缓存中最大允许的数目
	public static int config_cache_limit_count=10;
	public static String base_battery_path="/codebase/config/temp/battery/";
	public static String base_battery_bak_path="/codebase/config/encrypt/bak/battery/";
	public static String config_batterymath_xls="/codebase/config/encrypt/battery/battery_math.xlsx";
	public static String config_path_htmltemplate="/codebase/netmarkets/jsp/catl/battery/template/";
	public static String config_path_material_xlsx="/codebase/config/encrypt/battery/battery_material.xlsx";
	...
	public static String WTDOCUMENT_TYPE="wt.doc.WTDocument|com.CATLBattery.BatteryDocument|com.CATLBattery.IntelligentDocument";
	...
	public static String config_libary_batterymaterial="电芯EVC材料库";
	...
	public static String config_battery_xls_path="/codebase/config/custom/config/battery_config.xls";
	...
	public static String battery_encrypt_hsitory_password="wcadmin123";//历史密码记录，避免临时目录文件存在的文件不能使用新密码
	public static String battery_encrypt_password="wcadmin123";
	...
	public static String config_batteryasm_clf="MECHASM";
//	public static String config_batteryasm_clf="BATTERYASM";
//	public static String iba_attr_pn="CTAL_PN";
	public static String config_battery_iba_speicalkey="Special_Explanation";
	public static String config_compareversion_cell="设计主界面!O5";
	public static String config_battery_temp="/codebase/config/custom/temp/pd/";
	...
	public static String config_batterymath_name="EVC设计表模版";
	public static String config_libary_asmfolder="EVC机械件组合";
}
