...
public class UpdateDocType implements RemoteAccess{
    ...
    public static void invokeRemoteLoad(String filePath,String command){
        ...
        String CLASSNAME = UpdateDocType.class.getName();
    ...
    public static void doLoad(String filePath,String command){
        ...
        try {
            ...
            for(int i=1; i<=count; i++){
                ...
                String oldValue = iba.getIBAValue("CATL_DocType");
                if(oldValue != null && !oldValue.equals(""))
                	writer.write("doc:"+doc.getNumber()+",docType is not null:"+oldValue+"\n");
                else
                	data.put(doc,rows[1]); 
            }
