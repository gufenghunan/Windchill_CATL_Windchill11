...
public class UpdateWTPartMaturityTo2 implements RemoteAccess {
	...
	public static void main(String[] args) throws RemoteException, InvocationTargetException {
		...
		if (args == null || args.length < 3){
			...
			try {
				...
				.invoke("doLoad", UpdateWTPartMaturityTo2.class.getName(), null, types, values);
			} catch (WTException e) {
				e.printStackTrace();
			}
        }
	...
	public static void doLoad(String filePath) throws WTException, RemoteException{
		...
		try {
			...
			if (upFile != null && upFile.exists()){
		        ...
		        List<String> maturityFormatList = Arrays.asList("1","2", "3", "6");
