...
public class changeActionRB_zh_CN extends WTListResourceBundle{
    ...
    @RBEntry("Eidt Customer File")
    public static final String EDIT_CUSTOMER_FILE_DESCRIPTION="catl.editCustomerFile.description";

    @RBEntry("Eidt Customer File Title")
    public static final String EDIT_CUSTOMER_FILE_TITLE="catl.editCustomerFile.title";
    
    @RBEntry("netmarkets/images/multi_update.gif")
    public static final String EDIT_CUSTOMER_FILE_ICON="catl.editCustomerFile.icon";
