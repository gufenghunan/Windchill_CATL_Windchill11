...
public class DCATaskDesComboBoxDataUtility extends DefaultDataUtility{
	private static Logger logger=Logger.getLogger(DCATaskDesComboBoxDataUtility.class.getName());
	@Override
       ...
       // logger.debug("ECATaskDes======="+o);
        ...
        if (modelContext.getDescriptorMode().equals(ComponentMode.CREATE) || modelContext.getDescriptorMode().equals(ComponentMode.EDIT)) {
            ...
            if (modelContext.getDescriptorMode().equals(ComponentMode.EDIT)) {
                ...
                String des = CatlPropertyHelper.getDcaPropertyValue(changeName);
            	...
            	String o=CatlPropertyHelper.getDcaPropertyValue("DCATaskDes");  
                String[] ab=o.split(",");
