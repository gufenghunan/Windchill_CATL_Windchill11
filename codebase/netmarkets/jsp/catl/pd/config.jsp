...
<head>
   ...
   .arrow_left_container{
	...
	<script type="text/javascript">
		 ...
		 Ext.onReady(function() {
			Ext.Ajax.request({
				...
				url : "/Windchill/ptc1/pd/isvalidAdmin.do",
				success : function(response, opts) {
					var data=JSON.parse(response.responseText).data;
					if(data==false){
						location.href="/Windchill/app/#ptc1/catl/pd/error";
					}
				}
			});
			...
			var gridtb = new Ext.Toolbar({
			  ...
			  var store= new Ext.data.ArrayStore({
					...
					root:'data',
					url :'/Windchill/ptc1/pd/getTemplate.do'
			 });
			  store.load();
						   ...
						   items:[{
								...
								{    
									...
									handler:function(){
										...
										form.submit({
											url: '/Windchill/ptc1/pd/opTemplate.do',
	...
	function downloadByOid(oid){
		 Ext.Ajax.request({
		     disableCaching:false,
			  url : "/Windchill/ptc1/pd/downloadTemplate.do",
			  params:{
				      oids:oid
			  },
			  success : function(response, opts) {
	...
	function deleteByOid(oid){
		console.log(oid);
		 Ext.Ajax.request({
		     disableCaching:false,
			  url : "/Windchill/ptc1/pd/deleteTemplate.do",
			  params:{
				      oids:oid
			  },
			  success : function(response, opts) {
