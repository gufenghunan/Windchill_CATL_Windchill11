...
<%@page import="com.catl.part.PartLoadNameSourceUtil"%>
...
String a=request.getParameter("clsnode");
...
String namesouce ="";
if(clsnamesource.containsKey(name)){
	namesouce=clsnamesource.get(name);
}
out.println(namesouce);
