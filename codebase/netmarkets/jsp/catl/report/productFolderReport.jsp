...
function doSubmit()
{	
	var url = "<%=request.getContextPath()%>/netmarkets/jsp/catl/report/productFolderReportDownload.jsp";
...
<table width="500px">
	<tr>
		<td height="30" class="STYLE3" nowrap="nowrap">库-文件夹报表</td>
	</tr>
</table>
<table id="productFolderTable">
