...
function doSubmit()
{	
	var url = "<%=request.getContextPath()%>/netmarkets/jsp/catl/report/orgOrSiteGroupReportDownload.jsp";
...
<table width="500px">
	<tr>
		<td height="30" class="STYLE3" nowrap="nowrap">组信息报表</td>
	</tr>
</table>
<table id="orgOrSiteGroupTable">
