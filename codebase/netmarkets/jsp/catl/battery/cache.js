...
function getLocal(id){
	var storage_json=window.localStorage.getItem(id+"_local");
	if(storage_json==null){
		storage_json=window.localStorage.setItem(id+"_local","[]");
		return "[]";
	}
	return storage_json;
}
...
function setLocal(id,values){	
	...
	window.localStorage.setItem(id+"_local",JSON.stringify(json));
}
}
