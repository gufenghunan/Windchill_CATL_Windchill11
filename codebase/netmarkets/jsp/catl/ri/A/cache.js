...
function getLocal(id){
	var storage_json=window.localStorage.getItem(id+"_local_A");
	if(storage_json==null){
		storage_json=window.localStorage.setItem(id+"_local_A","[]");
		return "[]";
	}
	return storage_json;
}
...
function setLocal(id,values){	
	...
	window.localStorage.setItem(id+"_local_A",JSON.stringify(json));
}
}
